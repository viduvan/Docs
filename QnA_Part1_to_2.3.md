...
Nhìn vào công thức, thành phần $\text{SiLU}(x \cdot W_{gate})$ hoạt động chính xác như một cái **Cổng (Gate)** điều tiết luồng dữ liệu. Giá trị của cổng này sẽ nhân trực tiếp với nhánh thông tin đã được khai triển $(x \cdot W_{up})$. 
